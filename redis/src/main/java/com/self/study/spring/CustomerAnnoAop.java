...
@Component
@Aspect
public class CustomerAnnoAop  {

    @Autowired
    private RedisTemplate  redisTemplate;

    //  指定切入点
    @Pointcut("@annotation(com.self.study.spring.CustomerAnno)")
    ...
    public  Object  doCache(ProceedingJoinPoint joinPoint){
        ...
        try {
            ...
            CustomerAnno cacheAnnotation = method.getAnnotation(CustomerAnno.class);
